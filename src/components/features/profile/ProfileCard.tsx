...
export function ProfileCard({ drep }: ProfileCardProps) {
  return (
    <Card className="w-full bg-white shadow-sm space-y-2">
      <CardHeader className="pb-4">
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <div className="flex-1 flex flex-col md:flex-row gap-2">
            ...
            <Badge
              variant="secondary"
              className="w-fit mx-auto md:mx-0 bg-green-100 text-green-800 hover:bg-green-100 rounded-full"
            >
              {drep.status}
            </Badge>
          </div>
      ...
      <CardContent>
        <div className="w-full flex flex-col md:flex-row items-center gap-2 text-sm text-gray-600 overflow-hidden">
          <span>DRep ID:</span>
