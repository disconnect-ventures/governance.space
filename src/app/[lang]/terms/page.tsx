...
export async function generateMetadata({
  ...
  return {
    title: `${dictionary.pageTermsOfUse.title} - ${dictionary.metatags.title}`,
    ...
    <div className="bg-background text-foreground">
      ...
      <div className="mt-6 space-y-6">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Governance Space.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Governance Space, accessible
              from{" "}
              <a
        ...
        <ul>
          <li>
            By email:{" "}
            <a href="mailto:hello@governancespace.com">
