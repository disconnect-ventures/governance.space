...
export const metadata: Metadata = {
  title: "Governance Space - Terms of Use",
  description: "All-in-One Governance Platform",
};

export default async function TermsOfUsePage({ params: paramsPromise }: PageProps) {
  ...
  return (
    <div className="bg-background text-foreground">
      <PageTitle
        ...
        translations={dictionary.pageTermsOfUse}
      />
      <div className="mt-6 space-y-6">
        <p className="text-muted-foreground">Last updated: January 28, 2025</p>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Cayman Islands
            </p>
          </li>
          <li>
            <p>
              <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
              &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Governance Space.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Governance Space, accessible from{" "}
              <a href="https://governancespace.com/" rel="external nofollow noopener" target="_blank">
        ...
        <ul>
          <li>
            By email: <a href="mailto:hello@governancespace.com">hello@governancespace.com</a>
          </li>
        </ul>
      </div>
    </div>
