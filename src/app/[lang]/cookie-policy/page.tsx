      ...
      <div className="mt-6 space-y-6 text-foreground dark:text-foreground/80">
        ...
        <ul className="list-disc list-inside space-y-2 text-foreground/80 dark:text-foreground/70">
          <li>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to
            Governance Space.
          </li>
          <li>
            <strong className="text-foreground dark:text-foreground/90">
            ...
            means small files that are placed on Your computer, mobile device or
            any other device by a website, containing details of your browsing
          ...
          <li>
            ...
            or any legal entity on behalf of which such individual is accessing
