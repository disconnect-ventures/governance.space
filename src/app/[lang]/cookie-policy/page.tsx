  ...
  return (
    <div className="bg-background text-foreground dark:bg-background dark:text-foreground">
      ...
      <div className="mt-6 space-y-6 text-foreground dark:text-foreground/80">
        ...
        <h4 className="font-semibold mb-2 text-foreground dark:text-foreground/90">Interpretation</h4>
        <p>
          The words of which the initial letter is capitalized have meanings defined under the
          following conditions. The following definitions shall have the same meaning regardless of
          whether they appear in singular or in plural.
        </p>
        <h4 className="font-semibold mb-2 text-foreground dark:text-foreground/90">Definitions</h4>
        <p>For the purposes of this Cookies Policy:</p>
        <ul className="list-disc list-inside space-y-2 text-foreground/80 dark:text-foreground/70">
          <li>
            <strong className="text-foreground dark:text-foreground/90">Company</strong> (referred to
            as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
            this Cookies Policy) refers to Governance Space.
          </li>
          <li>
            <strong className="text-foreground dark:text-foreground/90">Cookies</strong> means small
          ...
          <li>
            <strong className="text-foreground dark:text-foreground/90">Website</strong> refers to
            Governance Space, accessible from{" "}
            <a
          ...
          <li>
            <strong className="text-foreground dark:text-foreground/90">You</strong> means the
        ...
        <h4 className="font-semibold mb-2 text-foreground dark:text-foreground/90">Contact Us</h4>
