  ...
  return (
    <div className="">
      ...
      <div className="mt-6 space-y-6 text-gray-700">
        ...
        <ul>
        <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Governance Space.</li>
        <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
        <li><strong>Website</strong> refers to Governance Space, accessible from <a href="https://governancespace.com/" rel="external nofollow noopener" target="_blank">https://governancespace.com/</a></li>
        ...
        <ul>
        <li>By email: <a href="mailto:hello@governancespace.com" target="_blank">hello@governancespace.com</a></></li>
        </ul>
